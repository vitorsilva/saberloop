...
Screenshots:
- `docs/issues/29-long-answers-initial.png` - Initial view (C/D hidden behind button)
- `docs/issues/29-long-answers-scrolled.png` - After scrolling, all 4 options visible
- `docs/issues/29-long-answers-selected.png` - Option D successfully selected
