...
- [ ] Retries on network error and eventually succeeds
- [ ] Retries with exponential backoff (1s, 2s, 4s)
- [ ] Gives up after max retries
- [ ] Does not retry non-retryable errors
- [ ] Logs telemetry for each retry attempt

### Integration Tests (openrouter-client.js)
- [ ] Retries fetch failures
- [ ] Retries 5xx server errors
- [ ] Retries 429 with extended delay
- [ ] Does NOT retry 401/402/400
...
- [ ] 1. Write failing tests for retry utility
- [ ] 2. Implement `src/utils/retry.js`
- [ ] 3. Tests pass
- [ ] 4. Write failing tests for openrouter-client retry integration
- [ ] 5. Modify `openrouter-client.js` to use retry
- [ ] 6. All tests pass
- [ ] 7. Manual testing
- [ ] 8. Create PR
